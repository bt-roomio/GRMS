  ...
  <div class="page" v-if="room_types">
    <div class="page__content">
      <PageHead
          ...
          :button="storePermissions.hasPermission('add_roomtype') ? $t('dashboard.configuration.room_type.add_room_type') : undefined"
          button-icon="plus"
    ...
    >
      ...
      <template #actions="{entity}">
        <div class="ui-table__actions col-2">
          <UiButton class="secondary" v-if="storePermissions.hasPermission('delete_roomtype')" @click.prevent="openEditRoomType(entity.id as string)">
            <UiIcon name="edit" filled />
          </UiButton>
          <UiButton class="text" v-if="storePermissions.hasPermission('change_roomtype')" @click.prevent="storeConfigurationRoomType.deleteItem(entity.id as string)">
