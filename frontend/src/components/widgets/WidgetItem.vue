...
onMounted(() => {
  ...
  const wsArgs = {...props.item?.descriptor.default_config?.ws_args, entityType: 'DEVICE', entityId: storeConfigurationDashboard.getAliasIsEqual(props.item?.descriptor.default_config?.ws_args)};
